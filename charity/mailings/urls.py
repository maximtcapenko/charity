...
urlpatterns = [
    ...
    path('groups/<uuid:id>/details/', views.get_group_details, name='get_group_details'),
    path('groups/<uuid:id>/edit/', views.edit_group, name='edit_details'),
    path('groups/<uuid:id>/recipients/add/', views.add_recipient, name='add_recipient'),
    ...
    path('content_fields', views.get_content_type_details, name='get_content_type_details')
]