...
urlpatterns = [
    ...
    path('index/partial/', views.get_current_details_partial, name='get_current_details_partial'),
    ...
    path('index/contributions/<uuid:id>/remove/', views.remove_contribution, name='remove_contribution'),
