...
urlpatterns = [
    ...
    path("<uuid:id>/incomes/<uuid:income_id>/details/", views.get_income_details, name="get_income_details"),
    path('<uuid:id>/expenses/<uuid:expense_id>/details/', views.get_expense_details, name='get_expense_details'),
    path('<uuid:id>/incomes/<uuid:income_id>/approvements/add/', views.approve_budget_income, name='approve_budget_income'),
    path('<uuid:id>/expenses/<uuid:expense_id>/approvements/add/', views.approve_budget_expense, name='approve_budget_expense'),
    ...
    path('<uuid:id>/incomes/<uuid:income_id>/edit/',views.edit_budget_income_details, name='edit_income_details'),
    path('<uuid:id>/expenses/<uuid:expense_id>/edit/',views.edit_budget_expense_details, name='edit_expense_details'),
]
